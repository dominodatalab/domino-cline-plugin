...
**Domino Logo:** Reference `assets/domino-logo.svg` from this skill's directory (e.g. `~/.cline/skills/domino-ui-design/assets/domino-logo.svg`). The SVG is white text on transparent background, designed for the dark nav bar.
